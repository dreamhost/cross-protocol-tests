...
class TestPublicReadS3Bucket(unittest.TestCase, S3BucketReadPermissions):
    ...
    def setUp():
        ...
        s3conn = get_s3conn()
        bucket = create_s3_bucket_with_acl('READ')
    ...
    def test_default_swift_object(self):
        ...
        unauthuser = get_unauthuser()
        eq(unauthuser.list_objects(bucket, filename), [filename])
    def test_default_s3_object(self):
        bucket = self.bucket
        filename = 'default-s3-object'
        text = 'default s3 object'
...
class TestPublicWriteS3Container(unittest.TestCase, S3BucketWritePermissions):
...
class TestPrivateWriteS3Container(unittest.TestCase, S3BucketWritePermissions):
...
class TestWritePermissions(object):
